    ...
    return (
        ...
        <div className="w-full md:max-w-[350px] flex flex-col bg-white border border-gray-200 rounded-lg shadow">
            ...
            <div className="p-5 flex flex-col flex-1">
                ...
                <Link href="#" className="inline-flex items-center px-3 w-28 py-2 text-sm font-medium text-center text-white bg-[#0eb2e7] rounded-lg hover:bg-[#48A2D4] focus:ring-4 focus:outline-none focus:ring-blue-300">
                    View All
